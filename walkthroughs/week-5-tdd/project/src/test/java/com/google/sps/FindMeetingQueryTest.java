...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void dontIncludeOptionalWhenNoAvailableTimes() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  @Test
  public void includeOptionalWhenAvailable() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  @Test
  public void justEnoughRoomOptionalCantMake() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
  ...
  @Test
  public void optionalsWithGapsInSchedule() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0800AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 1", TimeRange.fromStartEnd(TIME_0900AM, TIME_0930AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 1", TimeRange.fromStartEnd(TIME_1000AM, TIME_1100AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 1", TimeRange.fromStartEnd(TIME_1200PM, TimeRange.END_OF_DAY, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_B)),
        new Event("Event 1", TimeRange.fromStartEnd(TIME_1100AM, TimeRange.END_OF_DAY, false),
            Arrays.asList(PERSON_B))
    );
  ...
  @Test
  public void optionalsWithNoGapsInSchedule() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0800AM, false),
            Arrays.asList(PERSON_A)),
